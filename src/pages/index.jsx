...
const map_titles = (title, index, {length}) => {
    /* ... your code ... */
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt={bio.name} />
            <AboutSub>
              My name is David Parsons. I graduated Summa Cum Laude from Rutgers University in May of 2018
              and now I'm a Software Engineer at Capital One.
            </AboutSub>
          </AboutHero>
          <AboutDesc>
            At Capital One I work in Card & Small Buisness Tech on the Correspodence team. I primarly work in Python & Java based
            environments building and depolying services in both micro-service and FaaS backend infrastructures.
            <br/>
            <br/>
            I'm currently a first-year in Capital One's Technology Development Program. As a TDP I serve as a Lead on the Training and Development
            Committee and Project Lead on TDP Central: an Innersourced documentation and resource consolidation tool for TDPs.
            <br/>
            <br/>
            Outside of Capital One I'm an active Volunteer with FIRST Robotics, taking on the Key Volunteer/Leadership roles of Field
            Supervisor and Scorekeeper at various competitions across the Mid-Atlantic Region.
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Connect with me on
            <a href={bio.linkedin}> LinkedIn</a> or follow me on
